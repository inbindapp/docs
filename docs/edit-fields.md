# Edit Fields
Edit Fields provides capabilities for editing existing or setting up new fields for your collections, for example powerful programmatic SEO pages based on another collection or simply creating new generated field values.

There are two types of fields in Inbind:
...
Generated fields allow you to automatically populate field values using templates based on other fields in the same collection or related collections. They are also used for programmatic SEO by generating an entire collection’s content from a source collection.

For full details on how to create and use generated fields, see the [Generated Fields](./generated-fields) article.
